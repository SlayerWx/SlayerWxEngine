...
public:
	...
	void MaterialDraw(float* vertex, int vertexLength, unsigned int* index, int indexLength, glm::mat4 modelMatrix, bool alpha, glm::vec4& color, glm::vec3& ambient, bool diffuse, glm::vec3& specular, float& shininess);
	...
	void SetMaterial(Shader* shader, glm::vec4 &color, glm::vec3 &ambient,bool diffuse, glm::vec3 &specular, float &shininess);
};
// settings
